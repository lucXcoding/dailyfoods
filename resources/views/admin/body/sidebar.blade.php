<nav class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav">
        <li class="nav-item nav-category">Espace ADMINISTRATEUR</li>
        <li class="nav-item">
        ...
        <li class="nav-item nav-category">Gestion Utilisateurs</li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="uiComponents">
            <ul class="nav sub-menu">
              ...
              <li class="nav-item">
                <a href="{{ route('add.restaurant') }}" class="nav-link">Ajouter Restaurant</a>
              </li>
