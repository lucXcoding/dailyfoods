			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Daily<span>FOODS</span></a>
                    <h5 class="text-muted fw-normal mb-4">
                        Heureux de vous revoir ! Merci de vous identifier sur votre compte.</h5>
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('login') }}">
                      ...
                      <a href="register.html" class="d-block mt-3 text-muted">forgot password ?</a>
                    </form>
                  </div>
                </div>
              </div>
